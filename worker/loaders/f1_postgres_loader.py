...
class F1PostgresLoader:
    ...
    def _load_table(self, patterns: List[str], rename_map: Dict[str, str], table_name: str, primary_keys: List[str], date_columns: Optional[List[str]] = None, int_columns: Optional[List[str]] = None, float_columns: Optional[List[str]] = None) -> int:
